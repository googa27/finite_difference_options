"""Domain-specific exception classes used across the pricing framework."""
...
for _exception_class in (
    ...
    _exception_class.__module__ = "finite_difference_options.exceptions"


del _exception_class
