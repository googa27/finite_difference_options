...
class UnifiedPricingEngine:
    ...
    work to a concrete solver from :mod:`finite_difference_options.solvers.base`.
    ...
    def price_option(
        ...
        *grids: NDArray[np.float64],
        ...
        >>> from finite_difference_options.processes.affine import create_black_scholes_process
        >>> from finite_difference_options.pricing.engines.unified import (
        ...     create_unified_pricing_engine,
        ...     create_log_grid,
        ... )
        >>> from finite_difference_options.pricing.instruments.options import create_unified_european_call
