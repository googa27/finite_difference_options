...
def diffusion_to_covariance(diffusion: NDArray[np.float64]) -> NDArray[np.float64]:
...
def correlation_to_covariance(
    volatilities: NDArray[np.float64], correlation: NDArray[np.float64]
) -> NDArray[np.float64]:
...
def batch_covariance_computation(
    base_covariance: NDArray[np.float64], state_dependent_factors: NDArray[np.float64]
) -> NDArray[np.float64]:
