...
def _write_exceptions(policy: dict[str, Any], prefix: str, errors: list[str]) -> dict[str, set[str]]:
...
def validate_workflows(root: Path, errors: list[str], write_exceptions: dict[str, set[str]]) -> None:
