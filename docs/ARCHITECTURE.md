...
- state-factor roles (`tradable_spot`, `variance`, `volatility`, `short_rate`, `auxiliary_state`) used to validate payoff/process compatibility before payoff allocation;
- drift `b`;
- reaction/discount `c`;
- source `f`;
