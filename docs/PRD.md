...
Issue #63 makes this prohibition executable for callable fixed-rate bonds: Bermudan issuer exercise is represented by explicit cash-flow and call-schedule events in backward induction, while continuous exercise remains unsupported until a real obstacle/variational-inequality route exists. The callable-bond route is experimental reference evidence, not a production short-rate calibration claim.
