...
| basket option payoff on true multi-asset factors | `unsupported` | `FACTOR-ROLE-COMPAT-V0` | Standard one-strike basket payoff objects exist, but pricing routes require tradable-spot factor metadata; Heston variance/rate factors fail closed and are not basket assets; tracked by #45/#62. |
